...
void mause_callback(GLFWwindow* window, double xposIn, double yposIn)
{
	...
	// make sure that when the pitch is out of bounds the screen doestn't get flipped
	if (pitch > 89.0f)
		pitch = 89.0f;
	if (pitch < -89.0f)
		pitch = -89.0f;
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// Camera
		// ---------- To Do ----------
		// Setting the camera as well as everything above - classes in separate header files, with proper methods
		// Look at
		glm::mat4 view;
